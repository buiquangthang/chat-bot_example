...
class TelevisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create television" do
    assert_difference('Television.count') do
      post televisions_url, params: { television: { description: @television.description, name: @television.name, price: @television.price } }
    end
  ...
  test "should update television" do
    patch television_url(@television), params: { television: { description: @television.description, name: @television.name, price: @television.price } }
