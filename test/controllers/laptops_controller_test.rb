...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { description: @laptop.description, name: @laptop.name, price: @laptop.price } }
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { description: @laptop.description, name: @laptop.name, price: @laptop.price } }
